...
public class Receiver {
    ...
    Receiver(int port, String fileName){
        this.port=port;
    ...
    public void receiveAndCreate(int port, String fileName) throws IOException {
    ...
    public void sendAck(int lastSequenceNumber, DatagramSocket socket, InetAddress address, int port) throws IOException {
